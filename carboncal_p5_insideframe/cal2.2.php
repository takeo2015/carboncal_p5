...
<head>
    ...
    <script type="text/javascript">
        ...
        // display the overall carbon footprint
        function showCarbonFootprint(){
            var carbonTotal=<?php echo json_encode($_SESSION["carbonFootprint"]); ?>;
            console.log(carbonTotal);
            document.getElementById("carbonFootprintOverall").innerHTML = carbonTotal.toFixed(2);
        }
        ...
        function drawChart() {
            var travel=<?php echo json_encode($_SESSION["travelCO2"]); ?>;
            // console.log(travel);
            var clothing=<?php echo json_encode($_SESSION["clothesCO2"]); ?>;
            var housing=<?php echo json_encode($_SESSION["housingCO2"]); ?>;
            var food=<?php echo json_encode($_SESSION["foodCO2"]); ?>;
            var tech=<?php echo json_encode($_SESSION["techCO2"]); ?>;

            var data = google.visualization.arrayToDataTable([
                ['Category',                'CO2'],
                ['Transportation',          travel],
                ['Home energy use',         housing],
                ['Food',                    food],
                ['Technology purchases',    tech],
            ...
            var options = {
                title: 'My Carbon Footprint Breakdown',
                legend:'right'
            };
...
<body onload = "showCarbonFootprint()">
    <div class="content">
        <div class="calResultText">
            
            Based on the information you have provided, we have calculated your personal carbon footprint. 
            This number reflects the amount of greenhouse gas (GHG) emissions associated with your actions in 2019. Your footprint is expressed in &ldquo;tonnes of carbon dioxide equivalent&rdquo;  
            and includes all the main GHGs not just carbon dioxide. 
            Next to your total footprint you can see a breakdown by type of consumption (e.g., transportation, food, home energy, etc.) 
            and how much each of these contributed to your total footprint. 
            <br /><br /><br />
            <div class="center">
                <div class="text">
                    Your personal carbon footprint: <p id="carbonFootprintOverall" style="display:inline"></p> tonnes
                    <br /><br />
                    Please remember your personal carbon footprint to enter on the next page.
                </div>
        ...
        <center>
            <form method="post" action="qualtrics.php">
